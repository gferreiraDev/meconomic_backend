...
-- CreateIndex
CREATE UNIQUE INDEX "Statement_cardId_key" ON "Statement"("cardId");
...
-- AddForeignKey
ALTER TABLE "Statement" ADD CONSTRAINT "Statement_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
